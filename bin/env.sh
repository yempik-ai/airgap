...
LOCK_DIR API_KEY METRICS EXTRA_ARGS DEDUP LEAN_MCP CLAUDE_BIN CODEX_BIN PI_BIN HERMES_BIN PYTHON_BIN WITH_VENV \
CLAUDE_CODE_MAX_OUTPUT_TOKENS MAX_THINKING_TOKENS HERMES_MAX_TOKENS PROBE SKIP_BREW TOKENS PROMPT PROMPT_FILE ROW_FILE"
